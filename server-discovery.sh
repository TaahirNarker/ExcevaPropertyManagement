...
if [ "$PROJECT_FOUND" = true ]; then
    ...
    echo "   curl -o deploy-ssl-propman.sh https://raw.githubusercontent.com/osmannarker/ExcevaPropertyManagement/main/deploy-ssl-propman.sh"
    echo "   curl -o verify-ssl.sh https://raw.githubusercontent.com/osmannarker/ExcevaPropertyManagement/main/verify-ssl.sh"
    ...
    echo "   cd /var/www"
    echo "   sudo git clone https://github.com/osmannarker/ExcevaPropertyManagement.git"
